...
public class GainEffect implements Effect {
    ...
    public GainEffect() {
        ...
        supportedOutputFormats = new Format[]{new AudioFormat(AudioFormat.LINEAR,
                Format.NOT_SPECIFIED, 16, Format.NOT_SPECIFIED, AudioFormat.BIG_ENDIAN,
    ...
    public Format[] getSupportedOutputFormats(Format in) {
        ...
        if (!iaf.matches(supportedInputFormats[0]))
            return new Format[0];
        AudioFormat oaf = new AudioFormat(AudioFormat.LINEAR, iaf.getSampleRate(), 16, iaf
                .getChannels(), AudioFormat.BIG_ENDIAN, AudioFormat.SIGNED, 16,
