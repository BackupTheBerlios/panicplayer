...
public class PanicPlayer extends JFrame {
   ...
   protected void exitApplication() {
      int ret = JOptionPane.showConfirmDialog(this,
            Messages.getString("PanicPlayer.exit.text"), Messages.getString("PanicPlayer.exit.title"), //$NON-NLS-1$ //$NON-NLS-2$
      ...
      if (ret == JOptionPane.YES_OPTION) {
         ...
         try {
            ...
            JOptionPane.showMessageDialog(this,
                  Messages.getString("PanicPlayer.error.confsave.text") //$NON-NLS-1$
                        + t.getMessage(), errorString,
