...
public class MixEffect implements Codec {
	...
	public Format setOutputFormat(Format format) {
		...
		Logging.fine(
			"MixEffect: current output format set to " + currentFormat);
		return currentFormat;
	}
	...
	public OffsetedArray addOffsetedArrays(
		Set offsetedArraysSet,
		long length) {
		...
		for (Iterator iter = offsetedArraysSet.iterator(); iter.hasNext();) {
			...
			offsetedArrayResult =
				OffsetedArray.addOffsetedArray(
					offsetedArrayResult,
					currentOffsetedArray);
			i++;
		}
